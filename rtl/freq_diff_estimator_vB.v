...
module freq_diff_estimator (
    ...
    wire signed [57:0] term2_num;
    wire signed [58:0] term2_num_ext;
    wire signed [58:0] term2_rounded_num;
    wire signed [58:0] term2_div;
    ...
    // term2_q23 = round(term2_mul1 * 328 / 2^8)
    assign term2_num = term2_mul1 * $signed(10'sd328);
    assign term2_num_ext = $signed({term2_num[57], term2_num});

    // Round to nearest before signed division.
    // 2^7 is half of the 2^8 denominator.
    assign term2_rounded_num = term2_num_ext[58]
                             ? term2_num_ext - 59'sd128
                             : term2_num_ext + 59'sd128;

    assign term2_div = term2_rounded_num / 59'sd256;
