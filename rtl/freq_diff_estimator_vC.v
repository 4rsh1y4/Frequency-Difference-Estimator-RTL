...
// Version C:
// Quadratic scale = 32 / 25
// This directly implements the exact fixed-point coefficient.
...
module freq_diff_estimator (
    ...
    wire signed [52:0] term2_num;
    wire signed [53:0] term2_num_ext;
    wire signed [53:0] term2_rounded_num;
    wire signed [53:0] term2_div;
    ...
    // term2_q23 = round(term2_mul1 * 32 / 25)
    assign term2_num = $signed({{5{term2_mul1[47]}}, term2_mul1}) <<< 5;
    assign term2_num_ext = $signed({term2_num[52], term2_num});

    // For division by 25, adding/subtracting 12 implements nearest rounding.
    assign term2_rounded_num = term2_num_ext[53]
                             ? term2_num_ext - 54'sd12
                             : term2_num_ext + 54'sd12;

    assign term2_div = term2_rounded_num / 54'sd25;
